...
#define BS_IOPORT_7_VAL ((const uint8 CYFAR *)0x48000D90u)
...
#define BS_IOPINS0_7_VAL ((const uint8 CYFAR *)0x48000DA0u)

/* IOPINS0_1 Address: CYREG_PRT1_DM0 Size (bytes): 8 */
#define BS_IOPINS0_1_VAL ((const uint8 CYFAR *)0x48000DACu)
